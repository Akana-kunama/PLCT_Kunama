...
%define RosPkgName      gps-common
%define with_tests 0

Name:           ros-%{ros_distro}-%{RosPkgName}
Version:        0.3.3
Release:        1%{?dist}%{?release_suffix}
Summary:        GPS messages and common routines for use in GPS drivers
...
BuildRequires: ros-%{ros_distro}-rospy
...
%changelog
* Web Jan 10 2024 Timo Roehling timo.roehling@fkie.fraunhofer.de - 0.3.3-1
